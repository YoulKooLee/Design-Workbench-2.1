...
import { ApprovalNodeCard, APPROVAL_STATUS_PRESETS, Approver } from './index';

const NAME = 'ApprovalNodeCard';
const DESC = '工作流设计器的审批节点配置卡；流程实例详情里展示审批状态与当前审批人';
const PROMPT = '【组件引用】ApprovalNodeCard 审批节点卡（组件库 工作流）\n框架：React 18 + Tailwind v4（零第三方依赖）\n来源：03-组件库/03-页面组件/Codebuddy Design/工作流/ApprovalNodeCard.tsx\n用法：先把「Codebuddy Design」整目录复制到工程 src/component-templates/axhub/，然后\n  import { ApprovalNodeCard } from \'../../component-templates/工作流/ApprovalNodeCard\';\n参数：title/approvers/mode any|all|sequential/timeoutHours/timeoutAction/status/currentApprovers/comment/editable/onEdit/onRemove\n场景：工作流设计器的审批节点配置卡；流程实例详情里展示审批状态与当前审批人\n规则：请使用该组件，不要自造同类样式；零第三方依赖。';
