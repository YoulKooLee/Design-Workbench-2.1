...
const NAME = 'DataTable 数据表格';
const DESC = '列/排序/渲染插槽';
const PROMPT = '【组件引用】DataTable 数据表格（数据展示）\n框架：React + Tailwind v4\n用法：import { DataTable, type Column } from "../../component-templates/数据展示/DataTable"\n参数：columns（{title,key,sortable,align,render,width}）；data；rowKey；loading\n请在列表/表格类页面使用该组件。';
