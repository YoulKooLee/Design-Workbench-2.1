...
import { LineChart, AreaChart, BarChart, PieChart, DonutChart, Sparkline, ChartCard } from './index';

const NAME = 'Chart 图表';
const DESC = 'line/bar/pie';
const PROMPT = '【组件引用】Chart 图表（数据展示）\n框架：React + Tailwind v4\n用法：import { Chart } from "../../component-templates/数据展示/Chart"\n参数：type: line|bar|area|pie；data/series\n请在趋势/占比可视化场景使用该组件。';
