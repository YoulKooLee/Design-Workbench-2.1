...
const NAME = 'Descriptions 描述列表';
const DESC = '详情字段展示';
const PROMPT = '【组件引用】Descriptions 描述列表（数据展示）\n框架：React + Tailwind v4\n用法：import { Descriptions } from "../../component-templates/数据展示/Descriptions"\n参数：items: [{label,value}]；column；bordered\n请在详情页字段展示场景使用该组件。';
