...
function Demo() {
  const ITEMS = [
    { id: 'm1', name: '园区总览-主视觉.jpg', type: 'image', size: 2480000, width: 3840, height: 2160, uploadedAt: '2026-09-18 09:30', tags: ['头图'] },
    { id: 'm2', name: '安全态势-周报配图.png', type: 'image', size: 860000, width: 1920, height: 1080, uploadedAt: '2026-09-19 14:12', tags: ['安全'] },
    { id: 'm3', name: '人车态势-闸机抓拍.png', type: 'image', size: 620000, width: 1280, height: 720, uploadedAt: '2026-09-19 14:20' },
    { id: 'm4', name: '能耗能效-月度对比.png', type: 'image', size: 1180000, width: 1920, height: 1080, uploadedAt: '2026-09-20 10:05', tags: ['能耗'] },
    { id: 'm5', name: '消防运行-演练记录.mp4', type: 'video', size: 45800000, width: 1920, height: 1080, uploadedAt: '2026-09-20 16:40' },
    { id: 'm6', name: '园区导览图.pdf', type: 'file', size: 3200000, uploadedAt: '2026-09-21 09:15' },
    { id: 'm7', name: '深潜器下潜实拍.jpg', type: 'image', size: 1840000, width: 2560, height: 1440, uploadedAt: '2026-09-21 15:32', tags: ['科研'] },
    { id: 'm8', name: '实验室平面图.png', type: 'image', size: 740000, width: 1600, height: 900, uploadedAt: '2026-09-22 08:44' }
  ];
  const [sel, setSel] = React.useState(['m1', 'm3']);
  return (
    <DemoBoundary>
      <MediaPicker
        items={ITEMS}
        value={sel}
        onChange={(ids) => setSel(ids)}
        multiple
        max={5}
        columns={4}
        onUpload={() => {}}
