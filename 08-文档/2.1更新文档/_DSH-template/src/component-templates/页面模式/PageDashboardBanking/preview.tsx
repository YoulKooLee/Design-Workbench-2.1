...
import { PageDashboardBanking } from './index';

const NAME = 'PageDashboardBanking';
const DESC = '金融银行看板（账户 / 现金流 / 支出 / 卡片）';
const PROMPT = '【组件引用】PageDashboardBanking 金融银行看板（组件库 页面模式）\n框架：React 18 + Tailwind v4（零第三方依赖）\n用法：import { PageDashboardBanking } from "../../component-templates/页面模式/PageDashboardBanking"\n场景：银行/钱包应用首页（余额、现金流、支出构成、收入稳定性、卡片与账单）。页面级组件，直接整页使用。';
...
function App() {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1400, margin: '0 auto' }}>
      ...
      <DemoBoundary><PageDashboardBanking /></DemoBoundary>
