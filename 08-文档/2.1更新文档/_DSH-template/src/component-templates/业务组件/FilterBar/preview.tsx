...
import { FilterBar, FilterBarInline } from './index';

const NAME = 'FilterBar 筛选栏';
const DESC = '2/3/4 列筛选区';
const PROMPT = '【组件引用】FilterBar 筛选栏（业务组件）\n框架：React + Tailwind v4\n用法：import { FilterBar } from "../../component-templates/业务组件/FilterBar"\n参数：columns: 2|3|4；children（筛选控件）；onSearch；onReset\n请在列表页筛选区使用该组件。';
