...
import { Tooltip, Dropdown, Popover } from './index';
import { Button } from '../Button';

const NAME = 'Tooltip / Popover 浮层';
const DESC = '悬浮提示/气泡卡片/下拉';
const PROMPT = '【组件引用】Tooltip / Popover / Dropdown 浮层（基础）\n框架：React + Tailwind v4\n用法：import { Tooltip, Popover, Dropdown } from "../../component-templates/基础/Overlay"\n参数：Tooltip(content,placement)；Popover(content,triggerMode,children)；Dropdown(items,align,onSelect)\n请在悬浮提示/气泡卡片/下拉菜单场景使用浮层组件。';
