...
import { notification, NotificationHost } from './index';

const NAME = 'Notification 通知';
const DESC = '系统通知（函数调用）';
const PROMPT = '【组件引用】Notification 通知（反馈）\n框架：React + Tailwind v4\n用法：import { notification } from "../../component-templates/反馈/Notification"\n调用：notification.open({ title, description, type })\n请在系统级/需关注的通知场景使用。';
