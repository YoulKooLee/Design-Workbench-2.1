...
import { VerificationCode, PasswordInput, passwordStrength } from './index';

const NAME = 'VerificationCode 验证码';
const DESC = '分段输入';
const PROMPT = '【组件引用】VerificationCode 验证码（表单）\n框架：React + Tailwind v4\n用法：import { VerificationCode } from "../../component-templates/表单/VerificationCode"\n参数：value；onChange；onComplete\n请在短信/邮箱验证码输入场景使用该组件。';
