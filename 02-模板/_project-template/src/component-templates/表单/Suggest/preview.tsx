...
import { AutoComplete, Mention } from './index';

const NAME = 'Suggest 自动补全';
const DESC = '输入联想';
const PROMPT = '【组件引用】AutoComplete 自动补全（表单）\n框架：React + Tailwind v4\n用法：import { AutoComplete } from "../../component-templates/表单/Suggest"\n参数：options: [{value,label}]；value；onChange\n请在输入联想/搜索建议场景使用该组件。';
