...
import { RadioGroup, CheckboxGroup, Switch } from './index';

const NAME = 'Choice 单选/多选';
const DESC = 'radio/checkbox';
const PROMPT = '【组件引用】RadioGroup / CheckboxGroup 单选/多选（表单）\n框架：React + Tailwind v4\n用法：import { RadioGroup, CheckboxGroup } from "../../component-templates/表单/Choice"\n参数：options: [{value,label}]；value；onChange；direction\n请在少量选项单选/多选场景使用该组件。';
