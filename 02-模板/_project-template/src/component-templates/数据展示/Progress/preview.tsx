...
import { Progress, RingProgress, autoStatus } from './index';

const NAME = 'Progress 进度条';
const DESC = 'percent + 状态色';
const PROMPT = '【组件引用】Progress 进度条（数据展示）\n框架：React + Tailwind v4\n用法：import { Progress } from "../../component-templates/数据展示/Progress"\n参数：percent（0-100）；status: normal|success|warning|danger\n请在进度/容量占比场景使用该组件。';
