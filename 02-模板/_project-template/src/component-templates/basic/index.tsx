...
const COMPONENTS: CompMeta[] = [  { key: 'Button', name: 'Button 按钮', file: 'Button.tsx', cat: 'base', desc: '6 变体 × 3 尺寸 + loading + 图标', prompt: PROMPTS.Button },
  ...
  return (
    <div>
      <div style={{ marginBottom: 16, display: 'flex', alignItems: 'baseline', gap: 12, flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: 19, margin: 0 }}>组件库 · 基础组件</h1>
