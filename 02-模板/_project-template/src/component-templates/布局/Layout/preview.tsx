...
import { Space, Row, Col, Grid } from './index';

const NAME = 'Space / Row / Col 布局';
const DESC = '间距 / 24栅格 / Grid';
const PROMPT = '【组件引用】Space / Row / Col / Grid 布局（布局）\n框架：React + Tailwind v4\n用法：import { Space, Row, Col, Grid } from "../../component-templates/布局/Layout"\n参数：Space(direction,size)；Row(gutter)；Col(span 24栅格)；Grid(cols,gap)\n请在页面间距/栅格布局场景使用该组件。';
