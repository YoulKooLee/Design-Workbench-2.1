...
const COMPONENTS: CompMeta[] = [  { key: 'StatCard', name: 'StatCard 指标卡', file: 'StatCard.tsx', cat: 'data', desc: '指标 + 趋势 + 图标底色', prompt: PROMPTS.StatCard },
  ...
  return (
    <div>
      <div style={{ marginBottom: 16, display: 'flex', alignItems: 'baseline', gap: 12, flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: 19, margin: 0 }}>组件库 · 数据展示</h1>
