...
const COMPONENTS: CompMeta[] = [  { key: 'Modal', name: 'Modal 弹窗', file: 'Modal.tsx', cat: 'feedback', desc: '防误关 + Esc 关闭 + 滚动', prompt: PROMPTS.Modal },
  ...
  return (
    <div>
      <div style={{ marginBottom: 16, display: 'flex', alignItems: 'baseline', gap: 12, flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: 19, margin: 0 }}>组件库 · 反馈组件</h1>
