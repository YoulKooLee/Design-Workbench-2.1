...
const COMPONENTS: CompMeta[] = [
  { key: 'Button', name: 'Button 按钮', file: 'Button.tsx', cat: 'base', desc: '6 变体 × 3 尺寸 + loading + 图标', prompt: PROMPTS.Button },
  { key: 'Card', name: 'Card 卡片', file: 'Card.tsx', cat: 'base', desc: 'title/extra/bordered/flush', prompt: PROMPTS.Card },
  { key: 'Tag', name: 'Tag 状态标签', file: 'Tag.tsx', cat: 'base', desc: '5 色 + closable', prompt: PROMPTS.Tag },
  { key: 'StatCard', name: 'StatCard 指标卡', file: 'StatCard.tsx', cat: 'data', desc: '指标 + 趋势 + 图标底色', prompt: PROMPTS.StatCard },
  { key: 'DataTable', name: 'DataTable 表格', file: 'DataTable.tsx', cat: 'data', desc: '排序/斑马纹/空态/loading', prompt: PROMPTS.DataTable },
  { key: 'FormField', name: 'FormField 表单', file: 'FormField.tsx', cat: 'form', desc: 'Input/Select/FormRow', prompt: PROMPTS.FormField },
  { key: 'Modal', name: 'Modal 弹窗', file: 'Modal.tsx', cat: 'feedback', desc: '防误关 + Esc 关闭 + 滚动', prompt: PROMPTS.Modal },
  { key: 'ResultPage', name: 'ResultPage 结果页', file: 'ResultPage.tsx', cat: 'feedback', desc: 'success/error/warning/waiting', prompt: PROMPTS.ResultPage },
  { key: 'theme', name: 'theme.css 主题', file: 'theme.css', cat: 'theme', desc: 'Arco 色板 + 圆角 token', prompt: PROMPTS.theme },
];
  ...
  return (
    <div>
      <div style={{ marginBottom: 16, display: 'flex', alignItems: 'baseline', gap: 12, flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: 19, margin: 0 }}>组件库 · Design-components</h1>
