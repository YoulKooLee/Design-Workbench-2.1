...
import { PageDashboardAcademy } from './index';

const NAME = 'PageDashboardAcademy';
const DESC = '教育培训看板（课程表 / 作业 / 成绩 / 活动）';
const PROMPT = '【组件引用】PageDashboardAcademy 教育培训看板（组件库 页面模式）\n框架：React 18 + Tailwind v4（零第三方依赖）\n用法：import { PageDashboardAcademy } from "../../component-templates/页面模式/PageDashboardAcademy"\n场景：教学/培训管理看板（授课学生、出勤、作业批改、课程表与活动）。页面级组件，直接整页使用。';
...
function App() {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1400, margin: '0 auto' }}>
      ...
      <DemoBoundary><PageDashboardAcademy /></DemoBoundary>
