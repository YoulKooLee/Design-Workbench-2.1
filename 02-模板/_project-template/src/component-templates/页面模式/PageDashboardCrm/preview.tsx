...
import { PageDashboardCrm } from './index';

const NAME = 'PageDashboardCrm';
const DESC = '客户关系看板（漏斗 / 线索 / 商机）';
const PROMPT = '【组件引用】PageDashboardCrm 客户关系看板（组件库 页面模式）\n框架：React 18 + Tailwind v4（零第三方依赖）\n用法：import { PageDashboardCrm } from "../../component-templates/页面模式/PageDashboardCrm"\n参数：opportunities\n场景：销售/CRM 经营看板（线索价值、合格率、销售漏斗、区域分布与商机跟进）。页面级组件，直接整页使用。';
...
function App() {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1400, margin: '0 auto' }}>
      ...
      <DemoBoundary><PageDashboardCrm /></DemoBoundary>
