...
import { PageFormGroup } from './index';

const NAME = 'PageFormGroup';
const DESC = '分组卡片表单（视频参数/音频参数/填写说明 三组，三列栅格 + 单位后缀）';
const PROMPT = '【组件引用】PageFormGroup 分组表单页（组件库 页面模式）\n框架：React 18 + Tailwind v4（零第三方依赖）\n用法：import { PageFormGroup } from "../../component-templates/页面模式/PageFormGroup"\n参数：cardTitle；cardDesc；defaultValues；onSubmit\n场景：字段较多需分组归类的表单页。页面级组件，直接整页使用。';
