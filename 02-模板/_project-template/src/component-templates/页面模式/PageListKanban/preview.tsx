// @ts-nocheck
/**
 * 组件预览页 · 页面模式 / PageListKanban
 */
import React from 'react';
import { createRoot } from 'react-dom/client';
import '../../_kit/theme.css';
import { PageListKanban } from './index';

const NAME = 'PageListKanban';
const DESC = '看板（拖拽改状态 / 列排序 / 任务详情 / 新建）';
const PROMPT = '【组件引用】PageListKanban 看板（组件库 页面模式）\n框架：React 18 + Tailwind v4（零第三方依赖）\n用法：import { PageListKanban } from "../../component-templates/页面模式/PageListKanban"\n参数：columns；columnOrder\n场景：任务/需求看板（4 列拖拽流转、列排序、优先级与截止日期展示）。页面级组件，直接整页使用。';
