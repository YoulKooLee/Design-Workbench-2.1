...
import { PageFormBasic } from './index';

const NAME = 'PageFormBasic';
const DESC = '8 字段基础表单（含日期范围、多选、数字带单位、单选联动提示、必填校验）';
const PROMPT = '【组件引用】PageFormBasic 基础表单页（组件库 页面模式）\n框架：React 18 + Tailwind v4（零第三方依赖）\n用法：import { PageFormBasic } from "../../component-templates/页面模式/PageFormBasic"\n参数：cardTitle；cardDesc；defaultValues；onSubmit\n场景：信息项较少的标准表单页。页面级组件，直接整页使用。';
