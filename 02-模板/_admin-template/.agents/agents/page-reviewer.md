---
name: page-reviewer
description: Reviews generated page code for requirement completeness, spec compliance, and code quality. Scheduled as a role by the feature-dev skill in Step 6 (independent dispatch or main-session acting). Do not use as a skill entry — only via feature-dev role dispatch.
