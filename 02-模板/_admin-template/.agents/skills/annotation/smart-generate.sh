...
#
# 用法：
# bash .agents/skills/annotation/smart-generate.sh <page-path> [srs-path]
#
# 示例：
# bash .agents/skills/annotation/smart-generate.sh /customer/archive docs/01-需求与规划/示例科技客户关系管理模块-SRS需求规格说明书-V1.0.md
