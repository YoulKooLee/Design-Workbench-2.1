...
run('room-cli.mjs', ['put', room, here('deepseek-对齐Q1-Q8.md'), '--who', WHO]);
run('room-cli.mjs', ['say', room, '--i', 'review', '--body-file', here('_say8.md'), '--who', WHO]);
run('room-cli.mjs', ['handoff', room, 'qwen', '--body-file', here('_handoff8.md'), '--who', WHO]);
