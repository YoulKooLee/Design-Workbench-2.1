...
run('room-cli.mjs', ['put', room, here('deepseek-复核-qwen4冲突.md'), '--who', WHO]);
run('room-cli.mjs', ['say', room, '--i', 'review', '--body-file', here('_say7.md'), '--who', WHO]);
run('room-cli.mjs', ['handoff', room, 'qwen', '--body-file', here('_handoff7.md'), '--who', WHO]);
