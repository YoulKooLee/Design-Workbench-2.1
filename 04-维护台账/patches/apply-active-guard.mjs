...
// 用法：node 04-维护台账\patches\apply-active-guard.mjs
import { readFileSync, writeFileSync } from 'fs';
// 目标：工作台实际 make CLI（指标管理平台为 Make 宿主项目）。若其他项目装有 @axhub/make 且需复打，改此路径即可。
const CLI = path.resolve(__dirname, '..', '..', '01-项目', '指标管理平台', 'node_modules', '@axhub', 'make', 'dist', 'server', 'cli.mjs'); // 由本脚本位置推导（千问 P1-10）
